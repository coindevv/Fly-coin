...
void BitcoinGUI::loadTheme(QString theme)
{
    ...
    if (theme != "HardDefault") {
		...
		"QToolBar {background:#000;qproperty-iconSize: 24px 24px;qproperty-toolButtonStyle: ToolButtonTextBesideIcon;border:none;border-bottom:1px solid #333;padding:10px; width: 100%;}"
